set moduleName relu_array_ap_fixed_4u_array_ap_ufixed_6_1_5_3_0_4u_relu_config8_s
set isTopModule 0
...
set cdfgNum 36
set C_modelName {relu<array<ap_fixed,4u>,array<ap_ufixed<6,1,5,3,0>,4u>,relu_config8>}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer6_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "1024", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer6_out { ap_fifo {  { layer6_out_dout fifo_data_in 0 64 }  { layer6_out_empty_n fifo_status 0 1 }  { layer6_out_read fifo_port_we 1 1 }  { layer6_out_num_data_valid fifo_status_num_data_valid 0 11 }  { layer6_out_fifo_cap fifo_update 0 11 } } }
	layer8_out { ap_fifo {  { layer8_out_din fifo_data_in 1 24 }  { layer8_out_full_n fifo_status 0 1 }  { layer8_out_write fifo_port_we 1 1 }  { layer8_out_num_data_valid fifo_status_num_data_valid 0 32 }  { layer8_out_fifo_cap fifo_update 0 32 } } }
}
