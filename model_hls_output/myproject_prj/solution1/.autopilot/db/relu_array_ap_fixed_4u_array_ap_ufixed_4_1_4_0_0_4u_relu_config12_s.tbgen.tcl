set moduleName relu_array_ap_fixed_4u_array_ap_ufixed_4_1_4_0_0_4u_relu_config12_s
set isTopModule 0
...
set cdfgNum 36
set C_modelName {relu<array<ap_fixed,4u>,array<ap_ufixed<4,1,4,0,0>,4u>,relu_config12>}
...
set portList { 
	...
	{ layer10_out_num_data_valid sc_in sc_lv 9 signal 0 } 
	{ layer10_out_fifo_cap sc_in sc_lv 9 signal 0 } 
	...
	{ layer12_out_num_data_valid sc_in sc_lv 32 signal 1 } 
	{ layer12_out_fifo_cap sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "layer12_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "layer12_out", "role": "num_data_valid" }} , 
 	{ "name": "layer12_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "layer12_out", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "layer10_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "layer10_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "layer12_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	layer10_out { ap_fifo {  { layer10_out_dout fifo_data_in 0 32 }  { layer10_out_empty_n fifo_status 0 1 }  { layer10_out_read fifo_port_we 1 1 }  { layer10_out_num_data_valid fifo_status_num_data_valid 0 9 }  { layer10_out_fifo_cap fifo_update 0 9 } } }
	layer12_out { ap_fifo {  { layer12_out_din fifo_data_in 1 16 }  { layer12_out_full_n fifo_status 0 1 }  { layer12_out_write fifo_port_we 1 1 }  { layer12_out_num_data_valid fifo_status_num_data_valid 0 32 }  { layer12_out_fifo_cap fifo_update 0 32 } } }
}
