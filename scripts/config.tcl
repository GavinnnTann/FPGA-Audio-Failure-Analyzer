...
set SOURCE_FILES [list "recorder_top.v" "i2s_receiver.v" "uart_tx.v" "fft_window_buffer.v" "fft_magnitude.v" "mel_filterbank.v" "fft_feature_quantizer.v" "fft_frontend.v" "clk_gen.v" "spectrogram_pingpong.v" "cnn_axi_feeder.v" "cnn_anomaly_scorer.v" "cnn_wrapper.v"]
